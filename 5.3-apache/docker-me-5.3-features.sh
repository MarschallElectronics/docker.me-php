...
echo "-------------------------------"
apt-get install -y locales apt-transport-https nano git net-tools mailutils gnupg wget gcc make ssmtp
...
# a2enmod remoteip # gibts nicht für apache 2.2 (php 5.3 gibts nur für apache 2.2)


#
# docker image funktioniert nur mit ssmtp weil man werte in php.ini nicht ändern kann und dort als sendmailer ssmtp angegeben ist
#
